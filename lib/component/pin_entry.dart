...
class PinEntryTextFieldState extends State<PinEntryTextField> {
  ...
  Widget generateTextFields(BuildContext context) {
    List<Widget> textFields = List.generate(widget.fields.toInt(), (int i) {
  ...
  Widget buildTextField(int i, BuildContext context) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        maxLength: 1,
        style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontFamily: font_medium, fontSize: 14),
