...
install_xcframework "${PODS_ROOT}/Braintree/Frameworks/XCFrameworks/PPRiskMagnes.xcframework" "PPRiskMagnes" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/Braintree/Frameworks/XCFrameworks/CardinalMobile.xcframework" "CardinalMobile" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
