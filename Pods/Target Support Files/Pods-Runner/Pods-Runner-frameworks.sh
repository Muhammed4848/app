...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EpubViewerKit/EpubViewerKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/epub_viewer/epub_viewer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_braintree/flutter_braintree.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/platform_device_id/platform_device_id.framework"
